...
QUALITY_TO_MODEL_FILE = {
    "expert": Path("data/offline_rl_cql_expert.d3"),
    "mild": Path("data/offline_rl_cql_mild.d3"),
    "mixed": Path("data/offline_rl_cql_mixed.d3"),
...
def main() -> None:
    ...
    algo.fit(
        ...
        experiment_name=f"offline_rl_taxi_cql_{args.quality}",
        show_progress=True,
    )
