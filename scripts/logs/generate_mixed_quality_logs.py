...
RAW_LOG_FILE = Path("data/raw_taxi_logs_mixed_quality.jsonl")
TRANSITIONS_FILE = Path("data/transitions_mixed_quality.pkl")
POLICY_NAME = "mixed_quality_v1"
...
NOISY_BEST_VALUE_RANDOM_ACTION_PROBABILITY = 0.30
