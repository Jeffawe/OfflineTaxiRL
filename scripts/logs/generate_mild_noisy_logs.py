...
RAW_LOG_FILE = Path("data/raw_taxi_logs_mild_noisy.jsonl")
TRANSITIONS_FILE = Path("data/transitions_mild_noisy.pkl")
POLICY_NAME = "mild_noisy_best_value_v1"
RANDOM_ACTION_PROBABILITY = 0.10
    ...
    with RAW_LOG_FILE.open("w", encoding="utf-8") as raw_f, TRANSITIONS_FILE.open("wb") as trans_f:
        for episode_id in range(NUM_EPISODES):
            ...
            while not done and step_idx < MAX_STEPS_PER_EPISODE:
                ...
                (dx, dy), action_source = choose_action(taxi_pos_before, target_pos)
